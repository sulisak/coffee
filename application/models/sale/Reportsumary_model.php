...
$query = $this->db->query('SELECT 
    ...
    (SELECT sum(sd.product_price_discount) FROM sale_list_datail as sd WHERE sd.owner_id="'.$_SESSION['owner_id'].'" AND sd.adddate BETWEEN "'.$dayfrom.'" AND "'.$dayto.'") as discount_item,
