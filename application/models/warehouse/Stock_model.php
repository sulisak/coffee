...
$querynum = $this->db->query('SELECT
    ...
    WHERE wl.owner_id="'.$_SESSION['owner_id'].'" AND product_stock_num > "0"   AND wl.product_code LIKE "%'.$data['searchtext'].'%"
    OR wl.owner_id="'.$_SESSION['owner_id'].'" AND product_stock_num > "0" AND wl.product_name LIKE "%'.$data['searchtext'].'%"
    OR wl.owner_id="'.$_SESSION['owner_id'].'" AND product_stock_num > "0" AND z.zone_name LIKE "%'.$data['searchtext'].'%"
    OR wl.owner_id="'.$_SESSION['owner_id'].'" AND product_stock_num > "0" AND wc.product_category_name LIKE "%'.$data['searchtext'].'%"
