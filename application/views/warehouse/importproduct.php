...
<td align="center">
		...
		<tr>
			<td colspan="4" align="right"><?=$lang_all?></td><td align="right" style="font-weight: bold;">{{Sumnum() | number}}</td>
...
<form class="form-inline">
<div class="form-group">
<input type="text" ng-model="searchtext" ng-change="getlist(searchtext,'1')" class="form-control" placeholder="<?=$lang_search?> No. , ລະຫັດອ້າງອີງ, ໝາຍເຫດ" style="width: 300px;">
</div>
