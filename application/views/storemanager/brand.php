...
<button class="btn btn-default" ng-click="Updatelogomodal(x)">ອັບໂຫຼດໂລໂກ້ຮ້ານ</button>
...
, <?=$lang_tel?>: {{x.tel}}
			...
			<td>
	<span ng-if="x.owner_vat_status=='0'">ປິດ VAT</span>

<span ng-if="x.owner_vat_status=='1'">ພາສີລວມໃນສິນຄ້າ VAT Include</span>
<span ng-if="x.owner_vat_status=='2'">ພາສີແຍກຈາກສິນຄ້າ VAT Exclude</span>
<br />
	<span ng-if="x.owner_vat_status!='0'">	{{x.owner_vat}} % </span>
			...
			<td>
				<button ng-if="x.user_id!='1'" class="btn btn-warning btn-xs" ng-click="Openmodaledit(x)"><?=$lang_edit?></button>
			</td>
		</tr>
	...
	<input type="text" class="form-control" ng-model="x.footer_slip" placeholder="...">
	<br />
Youtube URL ສຳລັບຈໍລູກຄ້າ
<input ng-model="x.youtube_url_forcus" class="form-control">
				...
				<tr>
				<td>
		<button class="btn btn-success btn-lg" ng-click="Updatefooter_slip(x)">Save</button>
...
<button class="btn btn-default" ng-click="Updatebgimgmodal(x)">ອັບໂຫູດພາບພື້ນຫຼັງ</button>
<hr />
...
<div class="form-group">
			    			<select  class="form-control" style="height: 50px;font-size: 20px;" ng-model="owner_vat_status">
			    				<option value="0">ປິດ VAT</option>
			    				<option value="1">ພາສີລວມໃນສິນຄ້າ VAT Include</option>
			    				<option value="2">ພາສີແຍກຈາກສິນຄ້າ VAT Exclude</option>
			    			</select>
			    		</div>
...
<div class="modal fade" id="updatelogomodal">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">ອັບໂຫຼດໂລໂກ</h4>
			</div>
			<div class="modal-body">
...
<div class="modal fade" id="updatebgimgmodal">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">ອັບໂຫຼດພາບພື້ນຫຼັງ</h4>
			</div>
			<div class="modal-body">
