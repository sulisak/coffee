...
<span ng-if="x.user_type=='1'">ພະນັກງານຂາຍສິນຄ້າ</span>
<span ng-if="x.user_type=='2'">ພະນັກງານສະຕ໋ອກ</span>
<!-- <span ng-if="x.user_type=='3'">พนักงานคุมคลังสินค้าใหญ่</span> -->
<span ng-if="x.user_type=='4'" style="color: green;">Admin ຮ້ານ</span>
			</td>
			<td>{{x.user_email}}</td>
			<td>***</td>
...
<div class="form-group">
	<select ng-disabled="user_id=='1'" id="" class="form-control" ng-model="user_type" style="height: 50px;font-size: 20px;">
		<option value="4">Admin ຮ້ານ</option>
		<!-- <option value="0">พนักงานเปิดบิลสินค้า</option> -->
		<option value="1">ພະນັກງານຂາຍສິນຄ້າ</option>
		<option value="2">ພະນັກງານສະຕ໋ອກຮ້ານ</option>
...
$scope.foredit = false;
	...
	toastr.warning('ກະລຸນາໃສ່ຂໍ້ມູນໃຫ້ຄົບ');
}
