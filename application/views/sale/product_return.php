...
<form class="form-inline">
<div class="form-group">
<input type="text" ng-model="searchtext" ng-change="getlist(searchtext,'1')" class="form-control" placeholder="<?=$lang_search?> Return RunNo, Run no อ้างอิง, ชื่อลูกค้า" style="width: 400px;">
</div>
