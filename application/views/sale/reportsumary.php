...
<table class="table table-hover table-bordered">
	<thead>
		<tr class="trheader">
			...
			<th style="text-align: center;"><?=$lang_discount?>ໃນສິນຄ້າ</th>
			<th style="text-align: center;"><?=$lang_discount?>ທ້າຍບິນ</th>
...
<table ng-if="pawnadd_permoney!=null && pawnadd_cutmoney!=null" class="table table-hover" style="font-size: 18px;font-weight: bold;">
	<thead>
		<tr>
			<th>ລາຍໄດ້ຈາກດອກເບ້ຍ(ຮັບຝາກ)</th>
			<th>ລາຍໄດ້ຈາກຕັດເງິນຕົ້ນ(ຮັບຝາກ)</th>
		</tr>
	</thead>
	<tbody>
		<tr>
