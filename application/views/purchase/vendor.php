...
<table id="headerTable" class="table table-hover table-bordered">
	...
	<tr>
	<td></td>
			<td><input type="text" class="form-control" placeholder="ຊື່" ng-model="vendor_name"></td>
			<td><input type="text" class="form-control" placeholder="ທີ່ຢູ່" ng-model="vendor_address"></td>
			<td><input type="text" class="form-control" placeholder="ເລກຜູ້ເສຍພາສີ" ng-model="id_vat"></td>
			<td><input type="text" class="form-control" placeholder="%" ng-model="vat"></td>

			<td><button class="btn btn-success" ng-click="Savevendor(vendor_name)"><?=$lang_save?></button></td>
	</tr>
