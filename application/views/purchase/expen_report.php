...
<div ng-if="showloading">
	<center>
	 ...
	 ລະບົບກຳລັງໂຫຼດຂໍ້ມູນ ກະລຸນາລໍຖ້າ...
</center>
</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">ລາຍການສັ່ງຊື້ {{data_product_name}}</h4>
			</div>
...
<span  style="font-size: 20px;font-weight: bold;">ລາຍການຂາຍສິນຄ້າ Runno:{{sale_runno}}</span>
...
<tr><td align="right" colspan="7">ສຸດທິ</td>
